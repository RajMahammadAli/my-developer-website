      ...
      <div name="about" className="w-full ">
        <div className="container mx-auto ">
          <div className="min-h-screen">
            <div className="w-full lg:flex justify-center items-center gap-4 px-8">
              ...
              <div className="lg:w-1/2">
                <div className="flex justify-center items-center ">
                  <div className="p-8">
                    ...
                    <p className="pt-6">
                      Greetings! I'm [Your Name], a seasoned Full Stack Web
                      Developer passionate about crafting seamless digital
                      experiences. With a toolbox that includes HTML, CSS,
                      Bootstrap, Tailwind CSS, DaisyUI, React.js, Firebase, and
                      MongoDB, I specialize in creating dynamic, user-friendly
                      applications. My development journey is fueled by a
                      commitment to continuous learning and a design-forward
